  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 py-6 select-none">
      <motion.div
        ...
        className="w-full max-w-lg bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl p-6 md:p-7 text-center text-zinc-100"
      >
        {/* Title / Logo Header */}
        <div className="flex justify-center mb-3">
          <div className="bg-emerald-600/10 p-3 rounded-full border border-emerald-500/20 text-emerald-500 shadow-[0_0_15px_rgba(16,185,129,0.1)]">
        ...
        <div className="mb-5 text-left">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center bg-white rounded-lg mb-1.5 text-zinc-900 shadow">
                <Crown className="w-5 h-5 fill-zinc-900 stroke-zinc-900" />
              </div>
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center bg-gradient-to-br from-white to-zinc-900 rounded-lg mb-1.5 text-emerald-500 shadow border border-zinc-700">
            ...
            >
              <div className="w-8 h-8 flex items-center justify-center bg-zinc-900 rounded-lg mb-1.5 text-white border border-zinc-700 shadow">
                <Crown className="w-5 h-5 fill-white stroke-white" />
              </div>
        ...
        <div className="mb-6 text-left">
          ...
          <div className="mt-2.5 text-center bg-zinc-950/60 border border-zinc-800/80 rounded-xl py-2.5 px-4 shadow-inner">
        ...
        <motion.button
          ...
          className="w-full bg-[#81b64c] hover:bg-[#95ca5c] text-white font-extrabold text-base py-3.5 px-6 rounded-xl shadow-[0_4px_16px_rgba(129,182,76,0.3)] transition-colors duration-150 uppercase tracking-wide cursor-pointer"
        >
          Start Game
        </motion.button>
      </motion.div>
